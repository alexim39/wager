...
export class FeedbackService {
  ...
  // create new feedback
  create(feedbackObj: FeedbackInterface): Observable<ServerResponse> {
    return this.http.post<ServerResponse>(`${this.API_DOMAIN}/api/feedback`, feedbackObj, httpOptions)
      .pipe(
