...
export class PasswordService {
  ...
  // change password
  changePassword(passwordObj: ChangePasswordInterface): Observable<ServerResponse> {
    return this.http.put<ServerResponse>(`${this.API_DOMAIN}/api/password`, passwordObj, httpOptions)
      .pipe(
